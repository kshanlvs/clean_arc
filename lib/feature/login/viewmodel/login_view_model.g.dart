...
mixin _$LoginViewModel on LoginViewModelBase, Store {
  ...
  late final _$fetchDataAsyncAction =
      AsyncAction('LoginViewModelBase.fetchData', context: context);

  @override
  Future<void> fetchData(String email, String password) {
    return _$fetchDataAsyncAction.run(() => super.fetchData(email, password));
  }
